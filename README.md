...
- 1.4 **类型判断封装**（详细说明请查看代码注释 [src/core/Extensions.lua](https://github.com/wx771720/lua/blob/master/src/core/Extensions.lua)）
    - `xx.isNil`
    - `xx.isBoolean`
    - `xx.isNumber`
    - `xx.isString`
    ...
    - `xx.isUserdata`
    - `xx.isThread`
- 1.5 **表的封装**（详细说明请查看代码注释 [src/core/Extensions.lua](https://github.com/wx771720/lua/blob/master/src/core/Extensions.lua)）
    - `xx.tableClear`
    - `xx.tableClone`
    - `xx.tableMerge`
    - `xx.tableCount`
    - `xx.tableKeys`
    - `xx.tableValues`
- 1.6 **数组的封装**（详细说明请查看代码注释 [src/core/Extensions.lua](https://github.com/wx771720/lua/blob/master/src/core/Extensions.lua)）
    - `xx.arrayClear`
    - `xx.arrayCount`
    - `xx.arrayInsert`
    - `xx.arrayInsertASC`
...
- 2.8 **`Node:EventDispatcher` 树形结构的节点，继承自事件派发器，实现事件冒泡**
...
- 2.9 **`Framework` 项目框架类，实现了模块与状态机**
    - 9.1 模块（用法可参考 [src/module/timer/Mtimer.lua](https://github.com/wx771720/lua/blob/master/src/module/timer/MTimer.lua)）
